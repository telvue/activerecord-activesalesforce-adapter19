begin
  ...
  Jeweler::Tasks.new do |gemspec|
    gemspec.name = "bmckim-activerecord-activesalesforce-adapter"
    ...
    gemspec.email = "bmckim@gmail.com"
    gemspec.homepage = "http://github.com/bmckim/bmckim-activerecord-activesalesforce-adapter"
