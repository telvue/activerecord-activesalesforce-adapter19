begin
  ...
  Jeweler::Tasks.new do |gemspec|
    gemspec.name = "activerecord-activesalesforce-adapter19"
    ...
    gemspec.email = "brooke.mckim@gmail.com"
    gemspec.homepage = "http://github.com/brookemckim/activerecord-activesalesforce-adapter19"
